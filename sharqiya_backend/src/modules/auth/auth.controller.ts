...
/** httpOnly refresh cookies. Override with COOKIE_SECURE=true|false for HTTP Docker. */
...
export class AuthController {
  ...
  @ApiOperation({
    summary:
      'Login — returns an access token; the refresh token is set as an httpOnly cookie',
  })
  async login(
    @Body() dto: LoginDto,
